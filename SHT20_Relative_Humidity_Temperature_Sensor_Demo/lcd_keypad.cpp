...
void lcd_kbd::load_custom_symbol(void)
{
  uint8_t i = 0;
...
void lcd_kbd::print_custom_symbol(uint8_t x_pos, uint8_t y_pos, char symbol_index)
{
  goto_xy(x_pos, y_pos);
  send(symbol_index, DAT);
}
